...
print("13 May 2024")
print("I'm feeling spectacular today!")
print(
    "I hope that learning coding will be a fun experience and that it will be beneficial in my professional career as well as useful in my hobbies."
)
print("I'm excited to see what the future holds for me.")
print("🚀 🌕")
